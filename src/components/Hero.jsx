      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 pt-20 sm:pt-28 pb-24 sm:pb-32 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-12">
          ...
          <div className="text-center lg:text-left w-full lg:w-[55%] flex flex-col items-center lg:items-start">
            ...
            <h1 className="opacity-0 animate-fade-up animation-delay-75 text-[2.5rem] sm:text-[3.25rem] lg:text-[4rem] font-700 text-[var(--fg)] leading-[1.08] mb-6">
              Your trade business,<br />
              <span className="text-[var(--fg-muted)]">simplified.</span>
            </h1>

            <p className="opacity-0 animate-fade-up animation-delay-150 text-[var(--fg-muted)] text-base sm:text-lg mb-10 leading-relaxed max-w-md mx-auto lg:mx-0">
              CP12 certificates, invoices, job scheduling, and client management. One app for gas engineers.
            </p>

            <div className="opacity-0 animate-fade-up animation-delay-200 flex flex-col sm:flex-row items-center gap-3">
            ...
            <div className="opacity-0 animate-fade-up animation-delay-300 mt-10 flex items-center gap-5 text-xs text-[var(--fg-dim)] font-500 tracking-wide">
