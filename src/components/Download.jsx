    ...
    <section id="download" className="py-28 sm:py-36 lg:py-44 border-t border-[var(--border)]">
      <div className="max-w-4xl mx-auto px-6 sm:px-8" ref={ref}>
        ...
        <div className={`text-center ${inView ? 'opacity-0 animate-fade-up animation-delay-200' : 'opacity-0'}`}>
          <p className="text-[var(--fg-dim)] text-xs font-medium uppercase tracking-widest mb-6">Available now on the App Store</p>
          <a
            href="https://apps.apple.com/us/app/gaspilot/id6760321543"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 card px-6 py-3.5 rounded-xl"
          >
            ...
            <div className="text-left">
              <div className="text-[10px] text-[var(--fg-dim)] leading-snug font-medium">Download on the</div>
