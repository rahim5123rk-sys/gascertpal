  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-[72px]">
          ...
          <Link to="/" className="flex items-center gap-2.5 group">
            <div className="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-orange-500 to-amber-500 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/30 group-hover:scale-110 group-hover:shadow-orange-500/50 transition-all duration-300">
          ...
          <div className="hidden md:flex items-center gap-6 lg:gap-8">
            {isHome ? (
              <>
                ...
                <a href="#reviews" className="text-white/60 hover:text-white font-medium text-sm transition-colors duration-300">Reviews</a>
              </>
            ) : (
              <>
            ...
            <a
              ...
              className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all duration-300 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 hover:scale-105"
            >
              Download Free
            </a>
          </div>
      ...
      <div className={`md:hidden overflow-hidden transition-all duration-300 ${menuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
        <div className="bg-slate-950/98 backdrop-blur-2xl border-t border-white/5 px-4 py-5 flex flex-col gap-4">
          {isHome ? (
            <>
              ...
              <a href="#reviews" className="text-white/60 hover:text-white font-medium text-sm transition-colors" onClick={() => setMenuOpen(false)}>Reviews</a>
            </>
          ) : (
            <>
          ...
          <a
            href={isHome ? '#download' : '/#download'}
            className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-5 py-3 rounded-xl font-bold text-sm text-center shadow-lg shadow-orange-500/20"
